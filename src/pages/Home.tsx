      ...
      <section className="w-full  back-img mb-10">
        <div className="back flex flex-col items-center justify-center w-full ">
          <div className="w-11/12 flex flex-col">
            <h1 className="text-5xl font-bold w-1/2 mb-4">Be in Control of your greatest Assets</h1>
            <p className="text-xl font-normal w-2/5 mb-10">
              The most powerful and simplest way for Businesses to centralize all vehicle repair
              data in one place and uncover cost-saving insights
            </p>
            <Link to="singin">
      ...
      <section className="w-full flex items-center justify-center">
        <div className="flex items-center flex-col justify-center w-3/5 gap-10 p-10">
          <h1 className="font-bold text-3xl text-center">
            AI-Powered Software and Analytics Platform for the Automotive Aftersales sector
          </h1>
          <p className="flex items-center text-lg text-center">
            ...
            outdated fleet software – <br /> It brings all your vehicles’ repair and maintenance
            data into one place, for real-time insights that can reveal cost savings in the
            management of your assets, all without the need to manage any infrastructure.
          </p>
        </div>
      </section>
      <section className="w-full flex items-center justify-center">
        <div className="w-11/12 flex items-center justify-between bg-lightGray rounded-lg p-10">
          <div className="flex items-center flex-col justify-center w-3/5 gap-10 p-10">
            ...
            <p className="text-center text-lg">
              ...
              <br /> Check every estimate sent by your workshop or mechanic, against your local
              repair history and global library for your vehicle.
            </p>
            <div className="flex justify-around items-center w-full">
              <Link to="singin">
                <button className="bg-secondary w-40 h-14 rounded">Start FREE Trial</button>
              </Link>

              <Link to="singin">
                <button className="bg-primary w-44 h-14 rounded">Book a Demo</button>
              </Link>
            </div>
          </div>
          <div>
